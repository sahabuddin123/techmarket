    ...
    public function index()
    {
        ...
        $methods = [
            [
                ...
                'is_enabled' => Setting::getBool('payment_cod_enabled', true),
            ...
            [
                ...
                'is_enabled' => Setting::getBool('payment_bkash_enabled', false),
            ...
            [
                ...
                'is_enabled' => Setting::getBool('payment_nagad_enabled', false),
        ...
        return Inertia::render('Admin/Settings/PaymentMethods', [
            'methods' => $methods,
            'settings' => [
                'payment_cod_enabled' => Setting::getBool('payment_cod_enabled', true),
                ...
                'payment_bkash_enabled' => Setting::getBool('payment_bkash_enabled', false),
                ...
                'payment_nagad_enabled' => Setting::getBool('payment_nagad_enabled', false),
