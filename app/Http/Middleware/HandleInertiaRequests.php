...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            'tracking' => [
                'ga4_enabled' => (bool)(Setting::get('ga_measurement_id') ?: Setting::get('ga4_measurement_id')),
                'ga4_measurement_id' => Setting::get('ga_measurement_id') ?: Setting::get('ga4_measurement_id', ''),
                'ga4_ecommerce_enabled' => Setting::getBool('ga4_ecommerce_enabled', true),
                'ga4_debug_mode' => Setting::getBool('ga4_debug_mode', false),
                'gtm_enabled' => (bool)Setting::get('gtm_container_id'),
                'gtm_container_id' => Setting::get('gtm_container_id', ''),
                'meta_pixel_enabled' => (bool)(Setting::get('fb_pixel_id') ?: Setting::get('meta_pixel_id')),
                'meta_pixel_id' => Setting::get('fb_pixel_id') ?: Setting::get('meta_pixel_id', ''),
            ],
