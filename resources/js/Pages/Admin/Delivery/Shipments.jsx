...
export default function Shipments({ shipments, filters, metrics, providers }) {
  ...
  const getStatusBadge = (st) => {
    ...
    if (s.includes('cancel')) {
      return <span className="px-2.5 py-1 rounded-full text-[10px] font-black uppercase bg-slate-800 text-slate-400 border border-slate-700">Cancelled</span>;
    }
    ...
    <AdminLayout title="Shipments & Courier Logistics">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-1 shadow-lg col-span-2 sm:col-span-1">
        ...
        {/* Filters & Search */}
        <form onSubmit={handleFilter} className="bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-lg flex flex-wrap items-center gap-3">
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input
              ...
              className="w-full bg-slate-950 text-slate-200 pl-9 pr-3 py-2 rounded-xl border border-slate-800 focus:border-amber-500 text-xs"
            />
          </div>
          ...
          <select
            ...
            className="bg-slate-950 text-slate-200 px-3 py-2 rounded-xl border border-slate-800 text-xs font-bold"
          >
                    ...
                    <tr key={item.id} className="hover:bg-slate-800/40 transition">
                      ...
                      <td className="p-4 text-right space-x-2">
                        <button
                          ...
                          className="p-1.5 bg-slate-950 hover:bg-slate-800 text-amber-400 border border-slate-800 rounded-lg transition disabled:opacity-50 inline-flex items-center"
                        ...
                        {item.internal_status !== 'cancelled' && (
                          <button
                            ...
                            className="p-1.5 bg-slate-950 hover:bg-rose-500/10 text-rose-400 border border-slate-800 hover:border-rose-500/30 rounded-lg transition inline-flex items-center"
                            title="Cancel Parcel"
                          >
