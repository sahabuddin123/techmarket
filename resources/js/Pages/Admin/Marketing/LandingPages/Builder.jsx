...
export default function LandingPageBuilder({
  ...
  return (
    <AdminShell title={isNew ? 'Create Landing Page' : `Builder: ${data.name}`}>
      <Head title={isNew ? 'Create Landing Page' : `Builder — ${data.name}`} />

      <div className="space-y-4">
        {/* Top Control Bar */}
        <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 flex flex-col md:flex-row md:items-center justify-between gap-3 shadow-2xs">
            ...
            <div>
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="bg-transparent text-slate-900 dark:text-slate-100 font-black text-base sm:text-lg border-b border-transparent hover:border-slate-300 dark:hover:border-slate-700 focus:border-indigo-600 focus:outline-hidden px-1 font-heading"
                  placeholder="Landing Page Campaign Name"
                />
              </div>
              <p className="text-[11px] font-mono text-slate-500 px-1">
                Live URL: <span className="text-indigo-600 dark:text-indigo-400 font-bold">/l/{data.slug || 'your-slug'}</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <div className="flex items-center bg-slate-100 dark:bg-slate-800 p-1 rounded-xl border border-slate-200/80 dark:border-slate-700/80">
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                  viewport === 'desktop' ? 'bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 shadow-xs' : 'text-slate-500 hover:text-slate-900'
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                  viewport === 'mobile' ? 'bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 shadow-xs' : 'text-slate-500 hover:text-slate-900'
                }`}
              >
            ...
            <select
              ...
              className="bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-slate-200 px-3 py-2 rounded-xl text-xs font-bold border border-slate-200 dark:border-slate-700 focus:outline-hidden cursor-pointer"
            >
            ...
            {!isNew && landingPage?.slug && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 text-slate-700 dark:text-slate-300 text-xs font-bold transition-colors cursor-pointer border border-slate-200 dark:border-slate-700"
              >
            ...
            <button
              ...
              disabled={processing}
              className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition-all cursor-pointer shadow-xs disabled:opacity-50"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start min-h-[750px]">
          ...
          <div className="lg:col-span-3 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 p-3.5 space-y-3 shadow-2xs">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2.5">
              <div className="flex items-center gap-2 text-xs font-bold text-slate-900 dark:text-slate-100 uppercase tracking-wider font-heading">
              ...
              <button
                ...
                className="p-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-[10px] font-bold flex items-center gap-1 transition-colors cursor-pointer shadow-xs"
              >
                ...
                return (
                  <div
                    ...
                    className={`p-2.5 rounded-xl border transition-all cursor-pointer flex items-center justify-between group ${
                      isSelected
                        ? 'bg-indigo-50 dark:bg-indigo-950/50 border-indigo-200 dark:border-indigo-800 text-slate-900 dark:text-slate-100 shadow-2xs'
                        : 'bg-slate-50 dark:bg-slate-800/50 border-slate-200/80 dark:border-slate-700/80 text-slate-700 dark:text-slate-300 hover:border-slate-300'
                    }`}
                  >
                    <div className="flex items-center gap-2.5 truncate">
                      ...
                      <div className="truncate">
                        <p className="text-xs font-bold truncate leading-tight font-heading">{sec.title || tmpl.name}</p>
                        <p className="text-[10px] text-slate-400 uppercase tracking-wider font-mono">{tmpl.name}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-1 opacity-80 group-hover:opacity-100">
                      ...
                      >
                        {sec.is_visible ? <Eye className="w-3 h-3 text-emerald-600" /> : <EyeOff className="w-3 h-3 text-slate-400" />}
                      </button>
            ...
            <button
              type="button"
              onClick={() => setShowAddSectionModal(true)}
              className="w-full py-2.5 rounded-xl border border-dashed border-slate-300 dark:border-slate-700 hover:border-indigo-600 text-slate-500 hover:text-indigo-600 text-xs font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer bg-slate-50 dark:bg-slate-800/50"
            >
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-start bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 p-4 min-h-[700px] overflow-hidden shadow-2xl">
            <div className="w-full flex items-center justify-between pb-3 border-b border-slate-200/80 dark:border-slate-800/80 mb-4 text-xs text-slate-400 font-mono">
            ...
            >
                      ...
                      {sec.section_type === 'quick_order' && (
                        <div className="py-3 bg-slate-900 text-white rounded-lg p-3 space-y-2">
                          ...
                          <div className="space-y-1.5">
                            <input disabled placeholder="আপনার নাম (Full Name)" className="w-full bg-slate-50 dark:bg-slate-800 text-slate-200 p-1.5 rounded text-[11px] border border-slate-200 dark:border-slate-700" />
                            <input disabled placeholder="মোবাইল নম্বর (Phone Number)" className="w-full bg-slate-50 dark:bg-slate-800 text-slate-200 p-1.5 rounded text-[11px] border border-slate-200 dark:border-slate-700" />
                            <input disabled placeholder="পূর্ণ ঠিকানা (Delivery Address)" className="w-full bg-slate-50 dark:bg-slate-800 text-slate-200 p-1.5 rounded text-[11px] border border-slate-200 dark:border-slate-700" />
                          </div>
              ...
              {data.show_sticky_order_btn && (
                <div className="p-2.5 bg-slate-50 dark:bg-slate-800 border-t border-slate-200/80 dark:border-slate-800/80 flex items-center justify-between text-white">
                  <div>
          ...
          <div className="lg:col-span-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 p-4 space-y-4 shadow-2xs">
            {/* Top Sub-tabs */}
            <div className="flex items-center bg-slate-100 dark:bg-slate-800 p-1 rounded-xl border border-slate-200/80 dark:border-slate-700/80">
              <button
                type="button"
                ...
                className={`flex-1 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer text-center ${
                  activeTab === 'sections' ? 'bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 shadow-xs' : 'text-slate-500 hover:text-slate-900'
                }`}
              >
                Section Props
              </button>
              <button
                ...
                className={`flex-1 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer text-center ${
                  activeTab === 'settings' ? 'bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 shadow-xs' : 'text-slate-500 hover:text-slate-900'
                }`}
              >
                Page Setup
              </button>
              <button
                ...
                className={`flex-1 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer text-center ${
                  activeTab === 'tracking' ? 'bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 shadow-xs' : 'text-slate-500 hover:text-slate-900'
                }`}
              >
                Meta/GA4
              </button>
            ...
            {activeTab === 'sections' && activeSection && (
              <div className="space-y-3.5 text-xs text-slate-700 dark:text-slate-300">
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700/80 flex items-center justify-between">
                  <div>
                    <span className="text-[10px] text-indigo-600 dark:text-indigo-400 font-bold uppercase font-mono">Active Section</span>
                    <h3 className="font-bold text-slate-900 dark:text-slate-100 text-sm capitalize font-heading">{activeSection.section_type}</h3>
                  </div>
                  <label className="flex items-center gap-1.5 text-xs font-semibold cursor-pointer">
                    <input
                      ...
                      className="rounded text-indigo-600 focus:ring-0 border-slate-300"
                    />
                ...
                <div className="space-y-1">
                  <label className="block text-slate-700 dark:text-slate-300 font-bold">Section Heading / Title</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="block text-slate-700 dark:text-slate-300 font-bold">Section Subtitle / Description</label>
                  <textarea
                    rows={2}
                ...
                {activeSection.section_type === 'hero' && (
                  <div className="space-y-3 pt-2 border-t border-slate-100 dark:border-slate-800">
                    <div className="space-y-1">
                      <label className="block text-slate-700 dark:text-slate-300 font-bold">Badge Text (Top Pill)</label>
                      <input
                        type="text"
                        value={activeSection.settings?.badge || ''}
                        onChange={(e) => handleUpdateActiveSectionSetting('badge', e.target.value)}
                        className="w-full bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 p-2 rounded-xl border border-slate-200 dark:border-slate-700"
                        placeholder="🔥 LIMITED TIME OFFER"
                      />
                    </div>

                    <div className="space-y-1">
                      <label className="block text-slate-700 dark:text-slate-300 font-bold">CTA Button Text</label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1">
                      <label className="block text-slate-700 dark:text-slate-300 font-bold">Hero Showcase Image</label>
                      <MediaPicker
                ...
                {activeSection.section_type === 'offer' && (
                  <div className="space-y-3 pt-2 border-t border-slate-100 dark:border-slate-800">
                    <div className="space-y-1">
                      <label className="block text-slate-700 dark:text-slate-300 font-bold">Free Gift Callout</label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1">
                      <label className="block text-slate-700 dark:text-slate-300 font-bold">Urgency / Scarcity Subtext</label>
                      <input
                        type="text"
                ...
                {activeSection.section_type === 'video' && (
                  <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                    <label className="block text-slate-700 dark:text-slate-300 font-bold">YouTube / Video Embed URL</label>
                    <input
                      type="text"
                      value={activeSection.settings?.video_url || ''}
                      onChange={(e) => handleUpdateActiveSectionSetting('video_url', e.target.value)}
                      className="w-full bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 p-2 rounded-xl border border-slate-200 dark:border-slate-700 font-mono text-xs"
                ...
                {activeSection.section_type === 'gallery' && (
                  <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                    <label className="block text-slate-700 dark:text-slate-300 font-bold">Gallery Images</label>
                    <MediaPicker
            ...
            {activeTab === 'settings' && (
              <div className="space-y-3.5 text-xs text-slate-700 dark:text-slate-300">
                {/* Product Binding */}
                <div className="space-y-1">
                  <label className="block text-slate-700 dark:text-slate-300 font-bold">Target Hardware Product *</label>
                  <select
                    value={data.product_id}
                    onChange={(e) => setData('product_id', e.target.value)}
                    className="w-full bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 focus:outline-hidden font-medium cursor-pointer"
                  >
                    {products.map(p => (
                ...
                <div className="space-y-1">
                  <label className="block text-slate-700 dark:text-slate-300 font-bold">Custom URL Slug *</label>
                  <input
                    type="text"
                    value={data.slug}
                    onChange={(e) => setData('slug', e.target.value)}
                    placeholder="e.g. logitech-f310-special-offer"
                    className="w-full bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 font-mono"
                  />
                  {errors.slug && <p className="text-rose-600 text-[11px]">{errors.slug}</p>}
                </div>

                {/* Theme Accent Color */}
                <div className="space-y-1">
                  <label className="block text-slate-700 dark:text-slate-300 font-bold">Theme Accent Color</label>
                  <div className="flex items-center gap-2">
                    <input
                      type="color"
                    ...
                    <input
                      ...
                      value={data.theme_color}
                      onChange={(e) => setData('theme_color', e.target.value)}
                      className="flex-1 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 p-2 rounded-xl border border-slate-200 dark:border-slate-700 font-mono"
                    />
                  </div>
                </div>
                ...
                <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/80 space-y-2">
                  <div className="flex items-center justify-between">
                    <label className="font-bold text-slate-800 dark:text-slate-200">Delivery Rules</label>
                  ...
                  {!data.is_free_delivery && (
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <span className="text-[10px] text-slate-500 font-medium">Inside Dhaka (৳)</span>
                        <input
                          type="number"
                          value={data.inside_dhaka_charge}
                          onChange={(e) => setData('inside_dhaka_charge', e.target.value)}
                          className="w-full bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 p-1.5 rounded-lg border border-slate-200 dark:border-slate-700"
                        />
                      </div>
                      <div>
                        <span className="text-[10px] text-slate-500 font-medium">Outside Dhaka (৳)</span>
                        <input
                          type="number"
                ...
                <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/80 dark:border-slate-700/80 space-y-2">
                  <span className="font-bold text-slate-800 dark:text-slate-200 block">Contact & Floating Buttons</span>
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <span className="text-[10px] text-slate-500 font-medium">WhatsApp Number</span>
                      <input
                        type="text"
                        value={data.whatsapp_number}
                        onChange={(e) => setData('whatsapp_number', e.target.value)}
                        className="w-full bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 p-1.5 rounded-lg border border-slate-200 dark:border-slate-700 text-[11px]"
                      />
                    </div>
                    <div>
                      <span className="text-[10px] text-slate-500 font-medium">Call Support Phone</span>
                      <input
                        type="text"
            ...
            {activeTab === 'tracking' && (
              <div className="space-y-3.5 text-xs text-slate-700 dark:text-slate-300">
                <div className="p-2.5 rounded-xl bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 text-blue-800 dark:text-blue-300 text-[11px] leading-relaxed">
                ...
                <div className="space-y-1">
                  <label className="block text-slate-700 dark:text-slate-300 font-bold">Meta / Facebook Pixel ID</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="block text-slate-700 dark:text-slate-300 font-bold">Google Analytics (GA4) ID</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="block text-slate-700 dark:text-slate-300 font-bold">Campaign Code (UTM Tag)</label>
                  <input
                    type="text"
        ...
        {showAddSectionModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-xs">
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-2xl w-full p-6 space-y-4 shadow-2xl animate-in fade-in zoom-in-95 max-h-[85vh] flex flex-col">
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
                <div className="flex items-center gap-2 text-slate-900 dark:text-slate-100">
                  <Sparkles className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                  <h3 className="font-bold text-base font-heading">Add New Dynamic Section</h3>
                </div>
                <button
                  type="button"
                ...
                {SECTION_TEMPLATES.map((tmpl) => {
                  ...
                  return (
                    <div
                      ...
                      className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700/80 hover:border-indigo-600 dark:hover:border-indigo-400 transition-all cursor-pointer space-y-1.5 group"
                    >
                      <div className="flex items-center gap-2.5">
                        <div className="p-2 rounded-lg bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 group-hover:bg-indigo-600 group-hover:text-white transition-colors shadow-xs border border-slate-200/80">
                          <Icon className="w-4 h-4" />
                        </div>
                        <h4 className="font-bold text-slate-900 dark:text-slate-100 text-xs leading-tight group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors font-heading">{tmpl.name}</h4>
                      </div>
