      ...
      <main className="flex-1 max-w-[1640px] w-full mx-auto px-3 sm:px-6 py-5 space-y-7">
        ...
        {isSectionEnabled('hero_section') && (
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 sm:gap-4 items-stretch">
            ...
            <div 
              className="lg:col-span-8 bg-[#0a0e17] rounded-xl overflow-hidden relative shadow-xs group h-[240px] sm:h-[300px] md:h-[360px] lg:h-[400px]"
            ...
            >
              ...
              {slides.length > 1 && (
                <>
                  <button
                    onClick={prevSlide}
                    className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/90 hover:bg-white text-slate-900 flex items-center justify-center shadow-lg hover:scale-110 transition-all z-20 cursor-pointer"
                  ...
                  <button
                    onClick={nextSlide}
                    className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/90 hover:bg-white text-slate-900 flex items-center justify-center shadow-lg hover:scale-110 transition-all z-20 cursor-pointer"
                    title="Next Slide"
              ...
              {slides.length > 1 && (
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center space-x-2 z-20 bg-slate-950/40 px-3.5 py-1.5 rounded-full backdrop-blur-xs">
                  {slides.map((_, i) => (
                    <button
                      key={i}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-slate-200">
              <div>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight flex items-center">
                  <Zap className="w-6 h-6 text-[#ea580c] mr-2 fill-current" />
              ...
              <div className="flex items-center space-x-3">
                <div className="flex items-center space-x-1.5 text-xs font-bold">
                  <div className="bg-white border border-slate-300 rounded px-2.5 py-1 text-center shadow-xs">
                    <span className="font-mono text-[#ea580c] text-sm font-black">{String(timeLeft.days).padStart(2, '0')}</span>
                    <span className="block text-[8px] text-slate-400 uppercase -mt-0.5 font-bold">Days</span>
                  </div>
                  <span className="text-slate-400 font-bold">:</span>
                  <div className="bg-white border border-slate-300 rounded px-2.5 py-1 text-center shadow-xs">
                    <span className="font-mono text-[#ea580c] text-sm font-black">{String(timeLeft.hours).padStart(2, '0')}</span>
                    <span className="block text-[8px] text-slate-400 uppercase -mt-0.5 font-bold">Hours</span>
                  </div>
                  <span className="text-slate-400 font-bold">:</span>
                  <div className="bg-white border border-slate-300 rounded px-2.5 py-1 text-center shadow-xs">
                    <span className="font-mono text-[#ea580c] text-sm font-black">{String(timeLeft.minutes).padStart(2, '0')}</span>
                    <span className="block text-[8px] text-slate-400 uppercase -mt-0.5 font-bold">Mins</span>
                  </div>
                  <span className="text-slate-400 font-bold">:</span>
                  <div className="bg-white border border-slate-300 rounded px-2.5 py-1 text-center shadow-xs">
                    <span className="font-mono text-[#ea580c] text-sm font-black">{String(timeLeft.seconds).padStart(2, '0')}</span>
                    <span className="block text-[8px] text-slate-400 uppercase -mt-0.5 font-bold">Secs</span>
                  </div>
                </div>
        ...
        {isSectionEnabled('seo_content') && (
          <section className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-xs">
            ...
            >
              ...
              {seoExpanded ? <ChevronUp className="w-5 h-5 text-slate-500" /> : <ChevronDown className="w-5 h-5 text-slate-500" />}
            </button>

            {seoExpanded && (
              <div className="p-5 sm:p-6 pt-0 border-t border-slate-100 text-[13px] sm:text-sm text-slate-600 space-y-4 leading-relaxed">
                <div>
                  <h4 className="font-bold text-slate-900 mb-1 text-sm sm:text-[15px]">Best Computer Shop in Bangladesh</h4>
                  <p>
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-1 text-sm sm:text-[15px]">Buy the Best Laptop in Bangladesh from TechMarket BD</h4>
                  <p>
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-1 text-sm sm:text-[15px]">Best Gaming PC & Desktop Shop in Bangladesh</h4>
                  <p>
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-1 text-sm sm:text-[15px]">Best TV, Air Conditioner and Home Appliance Shop in Bangladesh</h4>
                  <p>
