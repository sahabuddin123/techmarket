        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 p-6 sm:p-8 lg:p-10 shadow-2xs">
          ...
          <div className="flex items-center justify-between py-4 text-xs">
            <span className="text-slate-700 font-bold">
              Showing <span className="text-[#0084ff]">{filteredList.length > 0 ? (currentPage - 1) * itemsPerPage + 1 : 0}</span> to <span className="text-[#0084ff]">{Math.min(currentPage * itemsPerPage, filteredList.length)}</span> of <span className="text-[#0084ff]">{filteredList.length}</span> entries
            </span>
                ...
                <tr className="bg-slate-50 border-b border-slate-200">
                  <td className="p-2 text-center">
                    <button
                      ...
                      onClick={handleReset}
                      title="Reset Filters"
                      className="w-8 h-8 mx-auto bg-[#0084ff] hover:bg-[#0070d6] text-white rounded-lg flex items-center justify-center transition-colors cursor-pointer shadow-2xs"
                    >
                  ...
                  <td className="p-2">
                    <select
                      ...
                      className="w-full bg-white text-slate-800 rounded-lg border border-slate-300 py-1.5 px-2 text-xs focus:outline-none focus:ring-1 focus:ring-[#0084ff]"
                    >
                      {couriers.map((c) => (
                  ...
                  <td className="p-2">
                    <input
                      ...
                      className="w-full bg-white text-slate-800 rounded-lg border border-slate-300 py-1.5 px-2.5 text-xs focus:outline-none focus:ring-1 focus:ring-[#0084ff] placeholder-slate-400"
                    />
                  </td>
                ...
                {paginatedList.length > 0 ? (
                  paginatedList.map((item, idx) => (
                    <tr key={item.no || idx} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-3 px-3 font-semibold text-[#0084ff]">
                        {item.pickup_point}
                      </td>
                  ...
                  <tr>
                    <td colSpan="6" className="py-12 text-center text-slate-400">
                      ...
                      <button
                        onClick={handleReset}
                        className="mt-2 text-[#0084ff] hover:underline text-xs font-bold"
                      >
                        Reset All Filters
                      </button>
                    </td>
